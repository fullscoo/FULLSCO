...
export default function EditStatisticPage() {
  const [, params] = useRoute("/admin/statistics/edit/:id");
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.error('خطأ في جلب بيانات الإحصائية:', error);
        setError(error instanceof Error ? error.message : "حدث خطأ أثناء جلب بيانات الإحصائية");
        toast({
          title: "خطأ في جلب البيانات",
          description: error instanceof Error ? error.message : "حدث خطأ أثناء جلب بيانات الإحصائية",
          variant: "destructive",
        });
      } finally {
        setIsLoading(false);
  ...
  const onSubmit = async (values: StatisticFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "تم تحديث بيانات الإحصائية بنجاح",
      });
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : "حدث خطأ أثناء تحديث الإحصائية",
        variant: "destructive",
      });
    } finally {
  ...
  return (
    <AdminLayout activeItem="statistics" title="تعديل الإحصائية" actions={actions}>
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle>تعديل الإحصائية</CardTitle>
          <CardDescription>
